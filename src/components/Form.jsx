...
const Form = () => {
    return (
        <section id="formSection" className="p-6 dark:text-gray-100">
            {/*<form noValidate=""*/}
            ...
            {/*                  className="block w-full p-2 rounded autoexpand focus:outline-none focus:ring focus:ri focus:ri dark:bg-gray-800"></textarea>*/}
            {/*    </div>*/}
            {/*    <div>*/}
            {/*        <button type="submit"*/}
            {/*                className="w-full px-4 py-2 font-bold rounded shadow focus:outline-none focus:ring hover:ring focus:ri dark:bg-violet-400 focus:ri hover:ri dark:text-gray-900">Send*/}
            {/*        </button>*/}
            {/*    </div>*/}
            {/*</form>*/}
        </section>
